...
const form = useForm({
    ...
    other_fees: tender.other_fees.toString(),
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="grid grid-cols-12 gap-4 px-3 mb-3">
                                ...
                                <label for="organisation_name"
                                    class="sm:col-span-2 col-span-12 col-form-label">Organisation
                                    Name</label>
                                <div class="sm:col-span-10 col-span-12">
                                    <div class="input-group">
                                        <TextInput v-model="form.organisation_name" type="text" required
                                            id="organisation_name" placeholder="Enter Organisation Name" />
                                ...
                                <div class="xl:col-span-4 col-span-6">
                                    ...
                                    <TextInput v-model="form.other_fees" type="number" min="0" id="other_fees" required
