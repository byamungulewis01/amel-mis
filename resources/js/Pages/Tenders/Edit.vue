...
const form = useForm({
    ...
    bid_security: tender.bid_security.toString(),
    tender_fees: tender.tender_fees.toString(),
    description: tender.description,
    opening_date: tender.opening_date,
    submitted_date: tender.submitted_date,
    bid_documents: { newPriceSchedule: '', bidSecurity: '', paymentDocument: '', registrationCert: '', taxClearance: '', vatCert: '' },

});

const submit = () => {
    Inertia.post(route('tenders.update', tender.id), {
        _method: "put",
        tender_name: form.tender_name,
        bid_security: form.bid_security,
        tender_fees: form.tender_fees,
        description: form.description,
        opening_date: form.opening_date,
        submitted_date: form.submitted_date,
        bid_documents: {
            newPriceSchedule: form.bid_documents.newPriceSchedule,
            bidSecurity: form.bid_documents.bidSecurity,
            paymentDocument: form.bid_documents.paymentDocument,
            registrationCert: form.bid_documents.registrationCert,
            taxClearance: form.bid_documents.taxClearance,
            vatCert: form.bid_documents.vatCert
        },
    });
};
    ...
    <AuthenticatedLayout>
                    ...
                    <div class="box-body">
                        <form @submit.prevent="submit">
                            ...
                            <div class="grid grid-cols-12 gap-4 px-3">
                                ...
                                <div class="sm:col-span-10 col-span-12">
                                    <div class="input-group">
                                        <textarea v-model="form.description" rows="5" id="description" class="form-control"
        ...
        dark:file:bg-black/20 dark:file:text-white/50 cursor-pointer">
                            ...
                            <div class="box-footer">
                                <button class="ti-btn ti-btn-primary btn-wave ms-auto float-right">Save
                                    Changes</button>
                            </div>
                        </form>
                    </div>
