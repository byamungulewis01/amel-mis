...
const reportInstance = (report_id) => {
    selectedId.value = report_id;
    showApprovalModal.value = true;
};
const approveReport = (report_id) => {
    // Assuming selectedTender contains the data of the user being updated
    const form = useForm({});
    form.put(route('weekly_reports.approve', report_id), {
        onSuccess: () => {
                            ...
                            <table class="table table-hover whitespace-nowrap min-w-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-start">Reported By</th>
            ...
            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                <div class="ti-modal-content w-full">
                    ...
                    <div class="ti-modal-body text-center">
                        <form @submit.prevent="approveReport(selectedId)">
